function XDE() {
	...
	if (document.getElementById('subred').value == "") {
		alert("Inserte una subred");
		return false;
	}


	if (document.getElementById('subred').value == "0") {
	...
	cont = 0;
    conC = 0;
	tabla1.innerHTML = "<thead><td class='td'>N. de subred</td><td class='td'>IP inicial</td><td class='td'>IP final</td><td class='td'>IP inicial en binario</td><td class='td'>IP final en binario</td><td class='td'>Hosts disponibles</td></thead>";
